...
const CSV_PATH = fs.existsSync(path.join(__dirname, "..", "medibot_realistic_india_master_dataset.csv")) 
  ? path.join(__dirname, "..", "medibot_realistic_india_master_dataset.csv")
  : path.join(__dirname, "medibot_realistic_india_master_dataset.csv");
...
app.listen(3000, '0.0.0.0', () => {
  console.log("🚀 Server running on port 3000 (Ollama + Gemini + Dataset)");
  console.log("🌐 Open in browser: http://localhost:3000");
  console.log("📱 Phone access: http://10.232.166.58:3000");
});
